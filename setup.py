...
modules = [
    ...
    'pyfr.solvers.edeuler',
    'pyfr.solvers.edeuler.kernels',
    'pyfr.solvers.edeuler.kernels.bcs',
    'pyfr.solvers.edeuler.kernels.rsolvers',
    'pyfr.solvers.edeulerdual',
    'pyfr.solvers.ednavstokes',
    'pyfr.solvers.ednavstokes.kernels',
    'pyfr.solvers.ednavstokes.kernels.bcs',
    'pyfr.solvers.ednavstokesdual',
    'pyfr.solvers.euler',
...
package_data = {
    ...
    'pyfr.solvers.edeuler.kernels': ['*.mako'],
    'pyfr.solvers.edeuler.kernels.bcs': ['*.mako'],
    'pyfr.solvers.edeuler.kernels.rsolvers': ['*.mako'],
    'pyfr.solvers.ednavstokes.kernels': ['*.mako'],
    'pyfr.solvers.ednavstokes.kernels.bcs': ['*.mako'],
