...
modules = [
    ...
    'pyfr.solvers.mpeuler',
    'pyfr.solvers.mpeuler.kernels',
    'pyfr.solvers.mpeuler.kernels.bcs',
    'pyfr.solvers.mpeuler.kernels.rsolvers',
    'pyfr.solvers.mpnavstokes',
    'pyfr.solvers.mpnavstokes.kernels',
    'pyfr.solvers.mpnavstokes.kernels.bcs',
...
package_data = {
    ...
    'pyfr.solvers.mpeuler.kernels': ['*.mako'],
    'pyfr.solvers.mpeuler.kernels.bcs': ['*.mako'],
    'pyfr.solvers.mpeuler.kernels.rsolvers': ['*.mako'],
    'pyfr.solvers.mpnavstokes.kernels': ['*.mako'],
    'pyfr.solvers.mpnavstokes.kernels.bcs': ['*.mako'],
