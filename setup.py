...
modules = [
    ...
    'pyfr.solvers.hypenavstokes',
    'pyfr.solvers.hypenavstokes.kernels',
    'pyfr.solvers.hypenavstokes.kernels.bcs',
    'pyfr.solvers.hypenavstokes.kernels.rsolvers',
    'pyfr.solvers.base',
...
package_data = {
    ...
    'pyfr.solvers.hypenavstokes.kernels': ['*.mako'],
    'pyfr.solvers.hypenavstokes.kernels.bcs': ['*.mako'],
    'pyfr.solvers.hypenavstokes.kernels.rsolvers': ['*.mako'],
