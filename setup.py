...
modules = [
    ...
    'pyfr.solvers.achdnavstokes',
    'pyfr.solvers.achdnavstokes.kernels',
    'pyfr.solvers.achdnavstokes.kernels.bcs',
    'pyfr.solvers.achdnavstokes.kernels.rsolvers',
...
package_data = {
    ...
    'pyfr.solvers.achdnavstokes.kernels': ['*.mako'],
    'pyfr.solvers.achdnavstokes.kernels.bcs': ['*.mako'],
    'pyfr.solvers.achdnavstokes.kernels.rsolvers': ['*.mako'],
