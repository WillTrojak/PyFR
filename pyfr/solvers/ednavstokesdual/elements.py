...
from pyfr.solvers.edeulerdual.elements import BaseEDDFluidElements


class EDDNavierStokesElements(BaseEDDFluidElements,
    ...
    def set_backend(self, *args, **kwargs):
        ...
        kprefix = 'pyfr.solvers.ednavstokes.kernels'
