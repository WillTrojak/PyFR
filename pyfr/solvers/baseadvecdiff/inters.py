...
class BaseAdvectionDiffusionIntInters(BaseAdvectionIntInters):
    def __init__(self, be, lhs, rhs, elemap, cfg):
        ...
        self._comm_lhs = self._vect_view(lhs, 'get_comm_fpts_for_inter')
        self._comm_rhs = self._vect_view(rhs, 'get_comm_fpts_for_inter')
...
class BaseAdvectionDiffusionMPIInters(BaseAdvectionMPIInters):
    def __init__(self, be, lhs, rhsrank, rallocs, elemap, cfg):
        ...
        self._comm_lhs = self._xchg_view(lhs, 'get_comm_fpts_for_inter')
