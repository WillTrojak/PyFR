...
class BaseEDDFluidElements(object):
    formulations = ['dual']
...
class EDDEulerElements(BaseEDDFluidElements, BaseAdvectionElements):
    def set_backend(self, *args, **kwargs):
        super().set_backend(*args, **kwargs)

        # Register our flux kernels
        self._be.pointwise.register('pyfr.solvers.edeuler.kernels.tflux')
        self._be.pointwise.register('pyfr.solvers.edeuler.kernels.tfluxlin')
