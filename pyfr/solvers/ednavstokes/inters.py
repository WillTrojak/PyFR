...
class EDNavierStokesIntInters(BaseAdvectionDiffusionIntInters):
    def __init__(self, be, lhs, rhs, elemap, cfg):
        ...
        self._be.pointwise.register('pyfr.solvers.ednavstokes.kernels.intconu')
        self._be.pointwise.register('pyfr.solvers.ednavstokes.kernels.intcflux')
...
class EDNavierStokesMPIInters(BaseAdvectionDiffusionMPIInters):
    def __init__(self, be, lhs, rhsrank, rallocs, elemap, cfg):
        ...
        self._be.pointwise.register('pyfr.solvers.ednavstokes.kernels.mpiconu')
        self._be.pointwise.register('pyfr.solvers.ednavstokes.kernels.mpicflux')
...
class EDNavierStokesBaseBCInters(BaseAdvectionDiffusionBCInters):
    cflux_state = None
    ...
    def __init__(self, be, lhs, elemap, cfgsect, cfg):
        ...
        self._be.pointwise.register('pyfr.solvers.ednavstokes.kernels.bcconu')
        self._be.pointwise.register('pyfr.solvers.ednavstokes.kernels.bccflux')
...
class EDNavierStokesNoSlpWallBCInters(EDNavierStokesBaseBCInters):
    type = 'no-slp-wall'
    cflux_state = 'ghost'
...
class EDNavierStokesSlpWallBCInters(EDNavierStokesBaseBCInters):
    type = 'slp-wall'
    cflux_state = None


class EDNavierStokesInflowBCInters(EDNavierStokesBaseBCInters):
    type = 'ed-in-fv'
    cflux_state = 'ghost'
...
class EDNavierStokesOutflowBCInters(EDNavierStokesBaseBCInters):
    type = 'ed-out-fp'
    cflux_state = 'ghost'
...
class EDNavierStokesCharRiemInvBCInters(EDNavierStokesBaseBCInters):
